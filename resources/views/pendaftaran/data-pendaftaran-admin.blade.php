                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('pendaftaran.print') }}" target="_blank" class="btn btn-info mb-4">
                                                        ...
                                                        <div class="col-md-6">
                                                            @if ($x->status_pendaftaran == 'Terverifikasi')
                                                                ...
                                                                @elseif($x->status_pendaftaran == 'Belum Terverifikasi')
                                                                    <span class="badge badge-warning">Belum <br> Diverifikasi
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                                                    ...
                                                                    <div class="py-2"><a class="dropdown-item"
                                                                        ...
                                                                        <div class="dropdown-divider"></div><a
                                                                            ...
                                                                            href="/invalid-registration/{{ $x->id_pendaftaran }}">Batal
                                                                            </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-3  col-lg-3 col-sm-4  col-6 mb-3">
                                                    <div class="d-flex project-image">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="fs-18 font-w500">{{ $x->nama }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-3  col-lg-6 col-sm-6 mb-sm-4 mb-0">
                                                    <div class="d-flex project-image">
                                                        ...
                                                        <div>
                                                            <small
                                                                class="d-block fs-16 font-w400">{{ $x->pilihan1->nama_paket }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2  col-lg-6 col-sm-4 mb-sm-3 mb-3 text-end">
                                                    <div class="d-flex justify-content-end project-btn">
                                                        ...
                                                        @else
                                                            <a href="detail-registration/{{ $x->id_pendaftaran }}"
                                                                class=" btn bgl-warning text-danger fs-16 font-w600">Batal
                                                                </a>
                                                        @endif

...
<head>
    ...
    <meta name="description" content="TRAEVL">
    <meta property="og:title" content="TRAVEL">
    <meta property="og:description" content="TRAVEL">

    <!-- PAGE TITLE HERE -->
    <title>PT SAKO UTAMA WISATA</title>
    <script src="https://kit.fontawesome.com/64d58efce2.js" crossorigin="anonymous"></script>
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('sipenmaru/images/test.png') }}">
    ...
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h1>PT SAKO WISATA UTAMA</h1>
                    <p>
                        Sistem Pendaftaran Jamaah Haji
                    </p>
                </div>
            </div>
